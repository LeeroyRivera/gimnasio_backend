...
const opciones = {
  // Configuraciones de la estrategia JWT, como la forma de extraer el token y la clave secreta.
...
passport.use(
  new JwtStrategy(opciones, async (payload, done) => {
    // Estrategia JWT para autenticar usuarios basándose en el token JWT proporcionado.
    try {
